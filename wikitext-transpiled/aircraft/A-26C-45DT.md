...
The '''{{Specs|name}}''' is a premium gift rank {{Specs|rank}} American bomber {{Battle-rating}}. It has been in the game since the start of the Open Beta Test prior to Update 1.27. It is exclusively available on Playstation and can be obtained by purchasing a special pack.
