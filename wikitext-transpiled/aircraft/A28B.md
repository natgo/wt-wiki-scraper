...
The A28B is an export variant of the British [[Vampire (Family)|Vampire FB 6]], also known as the [[Vampire (Family)|Vampire FB 50.]] It is an early Cold War era jet and was ordered in large numbers by the Swedish air force to leap into the jet age. The Vampire family is known for its great dogfighting capabilities, meaning the A28B can comfortably fend off several opponents at once if controlled by a skillful pilot. This aerial performance is given at the cost of engine power.
