...
{{Specs-Card
|code=saab_j29b
|images={{Specs-Card-Image|GarageImage_J_A29B.jpg}}
}}
...
The {{PAGENAME}} was fitted with internal deflatable fuel tanks that give this fighter more flexible fuel options when compared to the [[J29A]], this variant also gets suspended armament in the form of unguided rockets
