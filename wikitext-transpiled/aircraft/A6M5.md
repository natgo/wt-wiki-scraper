...
The last main-production variant of [[A6M]] series is the Model 52, once more the wings get redesigned, making them shorter and increasing the max speed. On top of wing changes, the engine performance was improved due to the modification of the Sakae engine's exhaust system to point the stacks aft and distributing them around the forward fuselage, providing an additional increase in thrust.
...
|-
| 703 <!-- {{Specs|destruction|body}} --> || {{Specs|destruction|gear}} || 397 || 368 || 220 || ~14 || ~6
|-
|}
