...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} Swedish strike aircraft {{Battle-rating}}. It was introduced in [[Update "Ground Breaking"]]. Being the first Viggen variant produced and intended to replace the [[A32A]], the {{PAGENAME}} offers the air-to-ground capability that the later [[JA37C]] lacks.
