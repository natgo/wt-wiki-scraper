...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} German aviation fighter {{Battle-rating}}. It was first introduced in [[Update 1.49 "Weapons of Victory"|Update 1.49 (aka 1.70.1945) "Weapons of Victory"]]. The Bf 109 B-1 is the first of the fabled 109s that make up the bulk of the German fighter forces in War Thunder. Used in combat in the Spanish Civil War, the B-1 allowed the Germans to acquire valuable combat experience and develop the Bf 109s further. The Bf 109 B-1 was designed by Willy Messerschmitt and Robert Lusser in the spring of 1937.
