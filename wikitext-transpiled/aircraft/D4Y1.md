...
The '''{{Specs|name}} mod. 11''', designated as the '''Suisei 11 ({{Annotation|彗星一一型|Comet, Model 11}})''', was a dive bomber developed to replace the [[D3A1]] with the primary design criteria being able to out-speed pursuers and out-range American carriers. With Japanese engine development lacking behind, the chosen high-output engine for the Suisei was the Aichi Atsuta 21 engine, a license-produced DB 601 found on the [[Bf 109 (Family)]] and many other German planes. While the engine outperformed its Japanese counterparts, the lack of industrial power, rare resources for parts and overall maintenance complexity strained its reliability and production numbers.
