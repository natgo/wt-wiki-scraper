...
The Suisei Model 22 upgrades the engine from a Aichi Atsuta 21 to an improved Atsuta 31 compared to its earlier model, the [[D4Y1]]. Next to its engine changes it comes with the possibility to equip rocket racks, which could load fused munitions to blow heavier bombers out of the sky.
