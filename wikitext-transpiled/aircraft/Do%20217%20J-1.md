...
This tactic is good for one reason: you have an arsenal of guns in the nose. Find a lone fighter and engage it head-on. If he tries to engage you, go ahead (unless he has hub mounted 37 mm cannon like some Yak versions, in that case don't engage). But keep in mind that you will need to wreck the enemy aircraft so you don't damage your aircraft. If the head-on fails, don't let the enemy plane chase you. Due to the very low mobility, that would be the worst. Try to build up speed as fast as possible to escape, in case of emergency you should shoot at him with your defensive gunners, unfortunately you do not do too much damage with the 7.92 mm, so it is important to avoid such situations. Once the head-on is complete, aim for the next enemy. Only turn towards the airfield again when all bombers/high fighters pass you, or are destroyed. This tactic is risky, but if you have a wingman fighter or two, it shouldn't be a problem.
