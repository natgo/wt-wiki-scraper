...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} American jet fighter {{Battle-rating}}. It was introduced in [[Update "Starfighters"]]. Designed for pure speed and acceleration, the F-104C is among the fastest planes at its BR, but its terrible manoeuvrability relegates it to the role of support fighter.
