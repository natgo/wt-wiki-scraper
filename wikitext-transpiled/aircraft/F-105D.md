...
|-
| 1,575 <!-- {{Specs|destruction|body}} --> || {{Specs|destruction|gear}} || 1,575 || 827 || 490 || ~12 || ~5
|-
|}
...
:This payload is best for bombing bases. It takes seven M117 bombs to destroy a base at its BR, and with 16 bombs, dropping in 5 pairs of 2 and 6 individual drops, an {{PAGENAME}} can easily pickle off four pairs of bombs (8 total) before using the remaining ones to destroy another base, lighting the afterburner, and heading for home.
