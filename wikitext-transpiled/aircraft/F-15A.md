...
* AIM-9M missiles are very effective with IRCCM

'''Cons:'''

* The aircraft is much more sluggish at higher fuel loads
* Large and easy to hit target
* Prone to wing overload until "Airframe" modification
* No TWS mode hinders BVR capabilities
* Can only carry four short-range IR missiles; two fewer than many of its peers
