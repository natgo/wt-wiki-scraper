...
While the F-4C's speciality is its AIM-7D Sparrow SARH (Semi-Active Radar Homing) missiles, in game (as they were in real life) they are quite ineffective, especially at this BR or above where many enemies will have an RWR to alert them the moment you lock them and/or countermeasures (as the missile is easily decoyed).
