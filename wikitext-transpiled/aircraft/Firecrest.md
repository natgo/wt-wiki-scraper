...
The '''{{Specs|name}}''' is a squadron rank {{Specs|rank}} British strike aircraft {{Battle-rating}}. It was introduced during [[Update 1.89 "Imperial Navy"]] as one of the first Squadron vehicles. It represents the attempt to develop an improved naval aircraft from the troubled [[Firebrand TF Mk IV|Blackburn Firebrand]].
