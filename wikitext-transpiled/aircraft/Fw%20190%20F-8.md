...
* While the plane does not have dedicated combat flaps, the take-off flaps can be used in place of it due to its very high rip speed (~700 km/h)
* Has an airspawn, allows the plane to easily get a head start above most fighters and intercept bombers
...
* Heavier and more sluggish than other Fw 190 variants, resulting into worsened handling, often got beaten by dedicated fighters in a dogfight
