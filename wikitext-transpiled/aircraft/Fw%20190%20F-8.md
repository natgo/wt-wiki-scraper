...
| rowspan="10" width="30%" | <div class="ttx-image">[[File:Hardpoints_Fw_190_D-9.png]]</div>
|-
...
* Flaps can tolerate a very high speed before breaking so you can use take-off flaps while turning to make the turns sharper
* One of the best planes available for CAS role in Ground Realistic Battles and even with heavy load-outs can still fight other planes and protect itself
* 1,000 kg bomb has a big blast radius and can be dropped on the ground to kill or critically damage enemy planes when they are chasing you
