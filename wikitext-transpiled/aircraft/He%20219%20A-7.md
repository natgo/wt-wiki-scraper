...
{| class="wikitable" style="text-align:center" width="50%"
! colspan="5" | [[FuG-220]] - Band B detection radar
|-
! Mode
! {{Annotation|Max detection<br>range|The maximum range at which a target can be detected}}
! {{Annotation|Effective<br>range|The maximum range at which a target can be detected with ~100% efficiency}}
! {{Annotation|Max azimuth<br>scan sector|How far to each side the radar can scan on the widest search mode}}
! {{Annotation|Max elevation<br>scan sector|How far up and down the radar can scan on the widest search mode}}
|-
...
** Can put wing fuel tank fires out in a dive as long as the engine is throttled back
