...
The I-15 M-25 has decent performance as a reserve fighter. This aircraft will often get into aerial engagements averaging with a 1.0 battle rating, however, the I-15 M-25 can still be a formidable machine, even in the hands of a novice:
...
The damage dealt from these machine guns is not bad, especially against biplanes and early wooden monoplanes, however, with opponents having a greater battle rating, the pilot will need to test different options to see what works best for them. All belts are quite similar in effectiveness to each other. While using an all tracer belt does not seem as powerful as the universal belt, they are extremely effective against early aircraft by lighting fuel tanks on fire, knocking out pilots and are extremely easy to use for new pilots as they will be able to see where all of their rounds are going and adjust fire to compensate when necessary. For the advanced pilot who wants to exercise the element of surprise, Stealth belts are the way to go.
...
* Very slow: cannot keep up with early monoplane fighters (e.g. [[He 112 (Family)|He 112]]) or even some bombers such as [[Do 17 E-1]]
