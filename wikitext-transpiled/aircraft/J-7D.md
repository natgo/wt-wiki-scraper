...
The J-7D (Chinese: 歼-7D型歼击机, AKA J-7IIIA 歼-7IIIA; unified NATO codename: Fishcan) was an upgrade of the previous J-7C (J-7III) which was based on Egyptian MiG-21MF with domestic avionics and HUD. After PLAAF got their hands on MiG-21MF from Egypt and the overall slow progress of J-8, there were plans that the reverse-engineered jet would replace J-8II series due to its slow progress as well as dire needs for interceptors against Soviet assaults; although the development for the jet was successful with better performance in some aspects, due to the success of J-8II and its subsystems, as well as introduction of Su-27SL Flanker-B to PLAAF, J-7D only received few orders only to utilize all the prebuilt airframes.  

Introduced in [[Update "Apex Predators"]], J-7D was a reverse-engineered version of the MiG-21MF from Egypt for all-weather operations, J-7D offers very similar performance to the late MiG-21 series with better engine and higher fuel capacity. While it lacks missiles for head-on/interception missions and large-calibre rockets like S-24s, the overall combat capabilities can be still ensured by its IR AAMs and variety of Chinese ground-attack weaponries.
