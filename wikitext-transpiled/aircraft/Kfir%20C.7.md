...
Introduced in [[Update "Winged Lions"]], the Kfir's weapons leave something to be desired, reflecting its real-life usage as a basic fighter-bomber. It can carry an impressive payload of bombs and rockets. Its best dogfight missile is the [[Python 3]], which is one of the most agile missiles in-game, it's also extremely quick to accelerate. However, the Kfir C.7 doesn't have access to any SARH missiles, limiting its BVR capability, and also lacks a proper radar (having only a radar rangefinder, linked to its gunsight). It also does not have guided air-to-ground weapons used by the [[Kurnass 2000]]. Thus, the Kfir requires a skilled pilot to take advantage of its excellent performance and IR missiles to win engagements. However, for its BR, it excels in its flight performance, it accelerates very rapidly, faster than MiG-21s and even 4th generation fighters like the F-16C and MiG-29SMT. Its DEFA 30 mm cannons have very good damage output, and are also rather easy to aim; they have a low fire rate, but this also means that their trigger time is higher than other 30 mm cannons.
...
|-
! Upgraded
| 2,457 || 2,388 || 26.0 || 27.0 || 268.9 || 224.6
|-
|}
