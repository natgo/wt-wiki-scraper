...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} Japanese jet fighter {{Battle-rating}}. It has been in the game since the start of the Open Beta Test prior to Update 1.27.
...
- Small, Light and nimble
  ...
  ** Rocket-propelled \*** High top speed
  **_ Outstanding acceleration
  _** Good climb rate
...
- Small and Light
  ...
  ** Rocket-propelled \*** Low fuel capacity
  \*\*\* Fuel runs out very fast
