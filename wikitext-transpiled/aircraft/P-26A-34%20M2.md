...
The P-26 can mount two 100 lb bombs, which drop together. These bombs can be used to decent effect against light ground targets, such as AI artillery and player-controlled open-top tanks. A direct hit will be needed to destroy harder targets such as tanks.
