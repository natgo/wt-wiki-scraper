...
Since the guns are mounted in the wings, gun convergence should be considered. Anywhere between 400-800 m should work well, but note that more distant convergence settings will make close range shooting more difficult, especially considering the low volume of fire.
...
* Not very durable
* The climb rate is not the best compared to other planes at the same BR
