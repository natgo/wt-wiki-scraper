...
The Q-5L (Chinese: 强-5L型强击机; unified NATO Codename: Fantan) was one of the final revisions of the Q-5 family by early 2000s for upgraded electronics for ground-attacking; Chinese have been a close observer of USAF's guided munitions all the way back in the Vietnam War where their [[AGM-62 Walleye (Family)|AGM-62 Walleye]] performed exceptionally good on assaulting critical infrastructures to stall the assaults from VC. After the failure to acquire foreign targeting pods due to political turmoil, PLAAF have started their tests with domestic LGB and its guidance pods by 1990s with different prototypes; while the plan for 2-plane formation (where one of them, a Q-5E will carry the bombs and the other Q-5F will carry the target pod) were ditched, new avionics ensured its capability to strike enemies with LGBs on single jet, thus the upgrades for the Q-5II (Q-5C; suffix with L when upgraded) and Q-5D (suffixed with N) became the standards for Q-5s before their ultimate decommission in early 2010s.

Introduced in [[Update "Fire and Ice"]] and being one of the final revisions of the Q-5 series in the PLAAF, the Q-5L is the most adept model of the Fantan in War Thunder for ground attack. Compared to previous models, it has an increased bomb payload and updated avionics such as a new FLIR sensor underneath the nose. The Q-5L unfortunately is not any better in air combat than the [[Q-5A]], because it still lacks air-to-air missiles and and in fact loses the valuable chaff/flare dispenser. Its deficits in air-to-air combat and fragility are compensated for by access to laser-guided bombs and a targeting pod with thermal optics, all at a much lower battle rating than the [[Jaguar GR.1A]] or [[Mirage 2000D-R1]]. In Ground RB, a well-flown Q-5L can blow enemy vehicles to smithereens with near impunity from enemy air defenses.
...
|-
| 1,260 <!-- {{Specs|destruction|body}} --> || {{Specs|destruction|gear}} || N/A || 500 || 450 || ~9 || ~5
|-
|}
