...
In Realistic battles, you should use the same tactics as in Arcade battles. Note that 2 x 500 kg FAB 500 bombs are enough to destroy a base at BR >2.3, but at lower ratings it is enough to drop only one bomb to get a base.
