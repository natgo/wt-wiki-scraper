...
It was introduced in [[Update 1.75 "La Résistance"]]. The '''{{Specs|name}}''' is the predecessor of the [[SB2U-2]], but it sits at a higher BR thanks to the armament. It is slightly slower, because of the engine, it uses the Pratt & Whitney R-1535-2, that has less HP than the SB2U-2, but the difference very little. It has access to the same payload, which means that it is excellent at dealing with heavily armoured naval targets and ground targets. The offensive armament is much better, with 4 x 12.7mm browning HMGs, while the SB2U-2 has access to only 2 x 7.7mm MGs. This means, that while the flight performance is mediocre, it can be used to some extent in air battles, since biplanes and early monoplanes are very vulnerable to this kind of machineguns, specially if incendiary bullets are used.
...
|-
! Stock
| 338 || 329 || rowspan="2" | {{Specs|ceiling}} || 23.6 || 24.5 || 3.7 || 4.5 || rowspan="2" | 300
|-
! Upgraded
...
* [https://live.warthunder.com/feed/camouflages/?vehicle=sb2u-3 Skins and camouflages for the {{PAGENAME}} from live.warthunder.com.]
