...
To add insult to injury, the Shackleton's belt options for the Hispano autocannons are also quite poor. The stock belt is the only belt with tracer rounds, with only half of the belt composed of a useful HEI ammunition, while the other half is taken by tracers and useless practice rounds. On the other hand, the upgraded belts offer high-penetrating AP rounds and more HE rounds, but lack tracer rounds entirely. This leaves the Shackleton with the tough choice of either an easier-to-aim belt with only half the chance of dealing damage, or highly destructive belt that can be very difficult to target at an enemy.
...
* 20 mm has no tracer rounds for the more powerful belts, making it difficult to aim
