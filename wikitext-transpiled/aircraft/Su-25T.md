...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} Soviet strike aircraft {{Battle-rating}}. It was introduced in [[Update "La Royale"]].

The Su-25T is a dedicated anti-tank variant of the legendary Su-25 "Grach". The airframe was adapted from a two-seat trainer variant and the appearance is more hump-backed than the original model. The nose houses the same "Shkval" targeting system as the [[Ka-50]] attack helicopter and can be further assisted with a Mercury targeting pod carried on the belly pylon. The Su-25T's signature weapon is the infamous 9K127 Vikhr beam-riding ATGM with large capacity, long range, and secondary anti-air capabilities, but it still has a classic arsenal of destructive unguided and laser-guided munitions, along with some TV-guided options. This Frogfoot can rain endless destruction on enemy vehicles in uncontested skies, but at such a high battle rating its subsonic flight performance is extremely lacking and it is not a significant threat in air combat. Su-25T pilots must be vigilant of enemy SAM and fighter capabilities and use its bag of tricks to stay alive.
...
The returning laser-guided Kh-25/ML and Kh-29L are far more viable than on the original Su-25 because of the advanced targeting systems. Although the [[MiG-27K]] is far better at using them for high-altitude "orbital strikes" because of its superior flight performance, they are fine for low-level attacks too. Amusingly, they can be used in a pinch for air combat: while lacking a proximity fuse, the semi-active laser guidance allows them to lead their targets while the Vikhr's beam riding cannot.
