...
When using this aircraft, you need to have in mind that you will need to master Ta 152's amazing flaps performance to masters this plane. Using landing flaps can be difficult initially, but it grants the fighter a incredible turn rate against all targets in its BR, making adversaries such as the F8F or La 9 easy targets. If you have the upper energy, making multiple enemies as P-51 and Ki-84 not so dangerous, and in ideal conditions making it more nimble than A6Ms and the Spitfire Mk IX.
