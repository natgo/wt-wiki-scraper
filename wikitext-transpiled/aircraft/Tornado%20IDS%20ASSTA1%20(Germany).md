...
# Acquisition: Although with the help of the FLIR pod you can easily spot the Pantsir's massive signature, that often means that it can see you too. A single teammate with a scout UAV or other method of reconnaissance can provide its precise location.
# Approach: Do not approach the battlefield directly. Instead, use a wide turn to approach from the flanks, using the terrain as cover. Make sure that the Pantsir isn't in cover from your angle. In most cases it will have its sight turned towards your team's spawn, allowing you to avoid detection.
