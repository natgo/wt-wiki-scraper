...
The Vautour IIN was a two seat interceptor jet powered aircraft designed by France in the 1950s. It was designed around the Vautour IIA but with a radar and all weather capabilities. It featured cannons and air to air missiles (both IR and radar guided) as offensive armaments. These aircrafts where used by Israel until the arrival of the Mirage IIIC when they where given to the "Knights of the Heart" division. The Vautours where replaced later by the A-4E Skyhawk and the F-4E Phantom being retired in 1972.

It was introduced in [[Update "Winged Lions"]] and is clasified as a bomber. Is better used in air RB and air SB since in other game modes faces enemies that are much more capable than the Vautour, like modern SPAA systems and supersonic interceptors in air AB. In air RB it can destroy almost 2 full bases and also has 4 x Shafrir missiles for air to air kills against distracted enemies. It also has a powerfull radar, with BVR capabilities, making it very usefull in SB to pick up enemies from long distances, and since most aircrafts at this BR lack RWR, most players wont know if they are being detected.

== General info ==
=== Flight performance ===
{{Specs-Avia-Flight}}
<!-- ''Describe how the aircraft behaves in the air. Speed, manoeuvrability, acceleration and allowable loads - these are the most important characteristics of the vehicle.'' -->The extra performance of the engines, compared to the ones used by the Vautour IIA, can be a very important diference in battle. When throttle is set to 110% the acceleration and overall engine power is increased in a very significant margin, at the cost of severe overheating when used constantly. While the Vautour has great engine power compared to other subsonic aircrafts, this mode allows regaining speed much faster. The flight performance may be sluggish, however is not as bad as other subsonic bombers like the Yak-28 and the B-57, allowing the Vautour to avoid early missiles and making evasive manoeuvres against other jets.
...
Since the Vautour has an air spawn, pilots attention should go to the armament area, unlocking the 500KG bombs and the 4 x Shafrir missiles. These 2 will allow pilots to destroy a full base and have 2 missiles for air to air kills. After these modifications are installed, focus on the performance upgrades and finally in the survivability modifications.{{Specs-Economy}}
...
The Vautour IIN was a two-seat, all-weather interceptor variant of [[S.O.4050 Vautour IIA|Vautour IIA]] with radar, and armed with cannons, air-to-air missiles, and unguided rockets. It was operated by the "Bat" squadron out of Tel Nof Airbase, until the arrival of the [[Shahak|Mirage IIIC]], when they were handed over to the "Knights of the Heart" division at Ramat David Airbase. The Vautour was used as aerial reconnaissance and night interceptors during the Six-Day War, as well as later in the 1960s. They were replaced by the [[A-4H (Israel)|A-4 Skyhawk]] and the [[Kurnass|F4-E Phantom]]. The Vautour was retired in 1972, with the "Knights of the Heart" division replacing them with the Skyhawk.
