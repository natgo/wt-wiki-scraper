...
The '''{{Specs|name}}'''(翼龙-1; Pterosaur-1) , designated as the GJ-1 (攻击-1; attacker-1) in PLAAF service, is one of the UCAV currently in PLAAF and foreign services; after seeing the potential of UCAVs during the Iraq War, a team of engineers from CAC started their development of UCAV from basic components and developed a prototype with such components. By the time of the advancement of PLAAF technologies, the team revoked their design with more standardized design in view of already acquired export orders by 2007; this led to the newly developed Wing Loong I in 2010's Zhuhai Air Show and been in-service with PLAAF in early-2010s, as well as exported to surrounding and Middle East countries as their new, economic UCAV fleet.

Introduced in [[Update "Drone Age"]] as one of the new UCAVs introduced in-game, '''{{Specs|name}}''' was the first PLAAF UCAV in service and is one of the earliest UCAVS to come from Asia. While the [[AKD-9]] AGMs lack both range and penetration compared to its contemporaries, the missiles are still adequate against enemy ground targets. It is however to be noted that the high SP cost to spawn a UCAV must be weighed against other available options, such as aircraft and helicopters, and only be spawned in if the player has no other close-air support option or deems the drone's benefits to be worth the high spawn cost.
