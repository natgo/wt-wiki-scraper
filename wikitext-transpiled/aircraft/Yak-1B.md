...
- [[A6M2|A6M2 Zeroes]]: They will out turn you, so try to attack in a shallow dive rather than a turn fight. Energy fighting is also okay because the Zero has poor energy retention and terrible high-speed control and handling. Never dogfight a Zero on its terms and be sure to keep a speed/energy advantage at all times. If things go south, break off and run away - the A6M2 is very slow. \*[[P-47_(Family)|P-47Ds]]: They are much faster than you and are excellent at boom and zoom, so avoid them if possible. If you are caught in a fight, try to energy fight them or turn to fight them.
