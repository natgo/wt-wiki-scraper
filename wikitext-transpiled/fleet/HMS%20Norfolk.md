...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} British heavy cruiser {{Battle-rating}}. It was introduced in [[Update "Direct Hit"]].

The Norfolk is a Norfolk-class heavy cruiser, subclass of the County-class cruisers built by the British post-Washington Treaty in the late 1920s for ocean power projection and trade protection. As a "treaty cruiser", the Norfolk sacrificed armour protection in favour of heavy 8-inch gun armament and high speed and endurance.
