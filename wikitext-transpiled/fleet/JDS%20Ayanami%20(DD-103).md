{{About
| about = post-war Japanese Ayanami-class destroyer '''{{PAGENAME}}'''
| usage = the Imperial Japanese Fubuki-class destroyer
| link = IJN Ayanami
}}

{{Specs-Card
|code=jp_destroyer_ayanami
|images={{Specs-Card-Image|GarageImage_{{PAGENAME}}.jpg|ArtImage_{{PAGENAME}}.png}}
}}

== Description ==
<!-- ''In the first part of the description, cover the history of the ship's creation and military application. In the second part, tell the reader about using this ship in the game. Add a screenshot: if a beginner player has a hard time remembering vehicles by name, a picture will help them identify the ship in question.'' -->
The '''{{Specs|name}}''' (あやなみ, [[Abbreviations#.28JP.29_Naval|namesake]]: Twilled Waves) was the first of the seven Ayanami-class destroyers that were built for the Japan Maritime Self-Defense Force (JMSDF) in the mid-1950s. She was part of a program to expand the JMSDF fleet size with larger and more capable vessels such as destroyers, following the Harukaze-class which were the first post-war destroyers of Japan. Although she was unofficially designated as a {{Annotation|DDK|Destroyer Anti-Submarine}}/{{Annotation|DDE|Destroyer Escort}}, she was officially classified as a {{Annotation|DD|Destroyer}} due to her size and displacement. She served as a reliable escort ship for many years. However, her armament was inadequate when she entered service but did not receive any major upgrades or modifications until her decommissioning in 1977.

It was introduced in [[Update "Danger Zone"]]. Technically a destroyer, JDS Ayanami's light armament leads it to be classified as a frigate in-game and be put in the Coastal tree. Compared to the preceding Isuzu, Ayanami is better in every way, having another pair of dual-purpose 76 mm guns, double the number of torpedoes, and is faster and has more crew. The 6 dual-purpose guns and modern FCS allows it to destroy aircraft and fight MTBs and other frigates effectively. Unfortunately, it can meet large destroyer leaders and light cruisers like [[USS Somers]] or [[HMS Dido]], which far outclass Ayanami in firepower and have the survivability and size to mostly ignore its guns. Ayanami can try to use its good accuracy and high rate of fire to target the guns of the larger ships, and then escape with smoke or close the distance and target them with torpedoes and depth charges.
...
{{main|Mk.10 Hedgehog mortar|Type 54 model 3 (533 mm)}}
...
;Skins
* [https://live.warthunder.com/feed/camouflages/?vehicle=jp_destroyer_ayanami Skins and camouflages for the {{PAGENAME}} from live.warthunder.com.]
