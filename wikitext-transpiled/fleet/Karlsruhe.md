{{Specs-Card
|code=germ_cruiser_karlsruhe
|images={{Specs-Card-Image|GarageImage_{{PAGENAME}}.jpg}}
}}

== Description ==
<!-- ''In the first part of the description, cover the history of the ship's creation and military application. In the second part, tell the reader about using this ship in the game. Add a screenshot: if a beginner player has a hard time remembering vehicles by name, a picture will help them identify the ship in question.'' -->
The '''{{Specs|name}}''' is a premium rank {{Specs|rank}} German light cruiser {{Battle-rating}}. It was introduced in [[Update "Direct Hit"]].
...
{{:SK C/32 (105 mm)/Ammunition|10.5 cm Sprgr. L/4.4 Kpf.Z, 10.5 cm Sprgr. L/4.4 Zt.Z, 10.5 cm L/4.2 AP}}
...
* Fair amount of crew
* Access to a scout plane
* Adequate anti-air capabilities
* Decent fire rate on main cannons
* 150 mm shells have a high muzzle velocity, making aiming easier

'''Cons:'''

* Prone to ammunition detonations
* Light armour struggles to resist fire from other cruisers 
