...
Introduced during [[Update 1.79 "Project X"]] when the Soviet fleet was implemented into the game, the OD-200 can obliterate small boats in its battle rating thanks to its quick-firing 37 mm guns and can be equipped with both high-explosive (HE) and armour-piercing (AP) belts to deal with a range of opponents.
