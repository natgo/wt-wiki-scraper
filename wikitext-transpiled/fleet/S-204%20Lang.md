...
The '''{{Specs|name}}''' is a premium gift rank {{Specs|rank}} German motor torpedo boat {{Battle-rating}}. It was one of the earliest [[wt:en/news/4355-shop-black-friday-thanksgiving-discounts-have-ended-en|pre-orders offered to access the fleet closed beta test]] before being removed from the store with the wide-release of the closed beta test in [[Update 1.79 "Project X"]].
