...
The '''{{Specs|name}}''' is a premium rank {{Specs|rank}} American destroyer {{Battle-rating}}. It was introduced in [[Update "New Power"]]. Thanks to the combination of the fast-firing guns, relatively low BR and a high {{sl}} reward multiplier the ship became well-known in the community as one of, if not ''the'' best [[Silver Lions]]-earner in the game.
