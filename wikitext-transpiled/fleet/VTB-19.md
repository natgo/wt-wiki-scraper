...
* '''13 mm HEIT belt:''' {{Annotation|IAI|Immediate-action incendiary}}{{-}}{{Annotation|IAI|Immediate-action incendiary}}{{-}}{{Annotation|IAI|Immediate-action incendiary}}{{-}}{{Annotation|T|Tracer}}
* '''AP-T:''' {{Annotation|AP|Armour-piercing}}{{-}}{{Annotation|AP|Armour-piercing}}{{-}}{{Annotation|AP|Armour-piercing}}{{-}}{{Annotation|T|Tracer}}

{{:Hotchkiss (13.2 mm)/Ammunition|T, IAI, AP}}
...
'''Pros:'''
* Ability to fire forward with all guns
* Excellent Oerlikon with a very good choice of ammunition
* Ability to switch to the secondary gun for added long-range anti-air cover from the AI gunners using the Oerlikon
* Tiny steering gear is very unlikely to suffer critical damage

'''Cons:'''
* Poor survivability for the BR
* Notably lower speed than other VTB boats
* Even with torpedo mode enabled, the torpedoes have only a 3 km range, making them very challenging to use in battles against bluewater vessels
