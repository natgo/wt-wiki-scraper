...
|-
! Comparable optics
| colspan="2" style="text-align:center;" | ___
|-
|}-->
...
{{Notice|Practicing with the shortstop key and 'sight lock' on options can increase the accuracy when doing quick shots, as the AUBL/74 lacks any stabilization}}
