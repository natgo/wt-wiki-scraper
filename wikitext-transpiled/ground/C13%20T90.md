...
The OTO Melara C-13 (introduced in [[Update "Direct Hit"]]) was a platform made to attempt to replace the aging M113's and similar vehicles that armies around the world had in service at the time. It would be made in such a way to allow it to install multiple different armaments and also be easily modified to suit different roles. OTO Melara made several prototypes of which some would mount the TUA (tow and armour) and some also mounting the OTO TC-25 turret. Ultimately although several countries showed interest it would not be picked up, at the time the market was very saturated with light tanks so being chosen became a harder task. The one represented in game is armed with a 90mm cockerill cannon which can fire HEAT and HESH munitions. This variant was made to support infantry and main battle tanks. In game the C-13 is one of the best light tanks at its battle rating due to the superior mobility and low profile. The C-13 is able to keep up with both tracked and wheeled peers on the battlefield, at time even surpassing them, due to this the C-13 can be a perfect scouting or flanking vehicle. As many vehicles in the Italian tech tree, it isn't very armoured however you will at times bounce certain shells if lucky, most machine guns wont penetrate you either. If fired by an APFSDS round the C-13 does have quite a lot of empty space so also at times a round may overpen you and not do any damage. You are quite weak against enemy aircraft and enemy artillery however so try to keep a look out and use your mobility to escape from sticky situations. This vehicle has great turret handling, but like the AUBL the cannon is not stabilized so firing on the move is quite risky. Due to it's current battle rating there is not much of a line up you can form with this vehicle so a player is forced to bring vehicles from lower battle ratings as backup. Overall a great light tank which once spaded can prove to be effective in the right hands.
