...
Introduced in [[Update "Direct Hit"]], the C-13 is considered one of the best light tanks at its battle rating due to its superior mobility and low profile. It can keep up with tracked and wheeled peers and, at times, even surpass them. This makes the C-13 a perfect scouting or flanking vehicle. Like many vehicles in the Italian tech tree, it lacks armour, but it may occasionally deflect certain shells and is resistant to most machine guns. However, if hit by an APFSDS round, the C-13 has a lot of empty space, so the round may over-penetrate and not cause any damage. The vehicle is vulnerable to enemy aircraft and artillery, so players should remain vigilant and use the mobility to avoid dangerous situations. The C-13 has excellent turret handling, but like the AUBL, its cannon is not stabilized, making firing on the move risky. Overall, the C-13 is a great light tank that, once spaded, can be quite effective in the right hands.
