...
The Marksman looks like Chieftain tank hull with a giant boxy turret in the middle of it. The turret has a radar on the back of it and clearly visible handles with cannons on its front. The front has a distinctive double slope. The turret only exists on one other tank in-game, the Swedish ItPsV 90. Technically, from behind the turret's shape may look a bit like the [[Gepard]], but it's gigantic in comparison.
