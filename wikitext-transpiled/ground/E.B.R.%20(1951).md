...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} French light tank {{Battle-rating}}. It was introduced in [[Update "Ground Breaking"]].
...
This wheeled light tank is extremely fast, a feature which is very useful for flanking manoeuvres. The EBR also excels in overextending tactics, as it drives forwards and backwards at the same speed. You have to be watchful of enemy tanks, as the EBR has very little armour.
