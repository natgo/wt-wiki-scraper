...
== Description ==
<!-- ''In the description, the first part should be about the history of the creation and combat usage of the vehicle, as well as its key features. In the second part, tell the reader about the ground vehicle in the game. Insert a screenshot of the vehicle, so that if the novice player does not remember the vehicle by name, he will immediately understand what kind of vehicle the article is talking about.'' -->The FIAT 6614 is an APC created by Fiat and OTO Melara together, in the post-war period Italy needed light vehicles that could be deployed quickly, and give support to the troops at the front the FIAT 6614 had all the requirements for this it was chosen both for the military role but also for the para-military role, the prototype was built in 1972, in which it underwent several modifications, FIAT was in charge of the engine and locomotive components while OTO MELARA was in charge of the armament and hull, the FIAT 6614 had the IVECO 8062.24 diesel engine that allowed the vehicle to reach 100 km/h, and the hull allowed it to carry between 3 to 10 soldiers, another interesting aspect was the ability of the vehicle, one of the prototypes produced will use the 106 mm cannon M40A1 recoilless rifle was presented to the Italian army but was never adopted for the simple reason that the army had better vehicles than the FIAT 6614 with the 106 mm, already in service or moreover the 106 mm cannon was becoming increasingly obsolete

In the game the FIAT 6614 was added with the Italian ground tech tree in the [[Update 1.85 "Supersonic"|1.85 "Supersonic" update]], it is a good light tank thanks to its top speed of 100 km/h you can already flank the enemy or position yourself in good places to surprise attack the enemy, which thanks to its 106mm equipped with HEAT and HESH can penetrate any target with HEAT, instead to destroy with a single shot the enemy you can use the HESH thanks to its explosive mass, instead with the possibility to use it in the amphibious mode you can also pass over a river or a small lake to outflank the enemy.
