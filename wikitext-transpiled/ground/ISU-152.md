...
The '''ISU-152''' is a Soviet self-propelled heavy howitzer used during World War II. It is very similar to the [[SU-152]], mounting the same 152 mm ML-20S howitzer on an IS heavy tank chassis. Since the main armament was mounted in a casemate, it required repositioning the entire vehicle using the tracks, which made it awkward to aim. To support more mobile infantry and armour attacks, it was employed as mobile artillery rather than directly engaging the enemy itself. It was employed in numerous campaigns and nations well into the 1970s.

Introduced in the Closed Beta Test for Ground Forces before Update 1.41, the ISU-152 is a tank destroyer that serves many different purposes. At this point, most of the enemy is heavily armoured, so the best ammunition to use is an armour-piercing shell. However, high-explosive shells remain a useful choice, particularly against vehicles with light armour. However, owing to this vehicle's incredibly long reload time, players must make sure every shot counts. Although protection is enhanced over the SU-152, it should not be relied upon in combat.
