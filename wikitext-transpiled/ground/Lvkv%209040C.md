...
The '''Luftvärnskanonvagn 9040C''' in short '''Lvkv 9040C''' is one of the many variation of the CV90, designed to combat enemy aircrafts and attack helicopters mainly compared to the regular CV90. Delivered in 1997 to the army, giving them a vehicle that can keep up with other units during an advance where they can be deployed fast to provide cover from hostile air units for infanteri and other combat units.
The swedish army ordered 30 of the variation Lvkv 90, only 3 of them got upgraded for an international use which is the Ceasar-standard. So there is only 3 '''Lvkv 9040C''''s version deployed so far.
