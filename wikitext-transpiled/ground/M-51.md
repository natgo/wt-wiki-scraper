...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} Israeli medium tank {{Battle-rating}}. It was introduced in [[Update "Wind of Change"]]. It is the starting tank of the Israeli tree, and can therefore be spawned several times in a single battle. It looks similar to the [[M4A1 (76) W]], but feels smoother at the edges and has a different weapon.
