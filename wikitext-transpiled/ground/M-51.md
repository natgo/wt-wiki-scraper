...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} Israeli medium tank {{Battle-rating}}. It was introduced in [[Update "Wind of Change"]]. It is the starting tank of the Israeli tree, and can therefore be spawned several times in a single battle. It looks similar to the [[M4A1 (76) W]], but feels smoother at the edges and has a different weapon. The M-51 is an upgunned version of Israeli modified M-50 Sherman tank which was essentially a British Firefly tank. Unlike the M-50, the M-51 was equipped with a Cummins VT-8-460 diesel engine and HVSS suspension.
