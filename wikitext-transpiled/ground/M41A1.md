...
Following the experience of using light tanks in World War II, the US wanted a more airmobile light tank armed with a high-velocity 76 mm cannon to allow the vehicle to better fend for itself. The design became designated as the ''M41'' with the nickname "Walker Bulldog", named after General Walton Walker who died during the Korean War. Further improvements led to the '''M41A1''' variant with a hydraulic turret traverse system and more ammo stowage. Despite being considered an improvement over the preceding M24 Chaffee, the M41 was still too heavy for airmobile operations, especially for an air-drop. The M41 would still see use with the US and its allies but would be replaced by the [[M551]].

Introduced alongside the initial American ground tech tree in [[Update 1.45 "Steel Generals"]], the M41A1 is a light tank that gives a very powerful punching 76 mm M32 gun, especially with its APDS ammunition. The good mobility, low profile, and high firepower makes the M41A1 ideal as a scout and flanker for the team. The M41A1 has a relatively low top speed so it may not be the fastest vehicle to get to a destination. However, it has a high acceleration which means that the M41 can get to its top speed pretty quickly for speedy advances or retreats.
...
* If you pack 15&nbsp;''(+50)'' shells, it will keep most of the hull empty of ammo.
