...
During the Cold War, West Germany acquired as many as 650 [[M48A2_C|M48 Patton tanks]] from United States. As the years pass, the M48 slowly became outdated and needed constant upgrades to stay up to date with the latest advancements in tank technologies and the Soviet threat. One such upgrade was in the 1960s as the M48A2 C tanks were upgraded into [[M48A2_G_A2|M48A2 G A2]] that had the 105 mm L7 cannon installed and also use the German MG3 machine gun. However, as Leopard tanks slowly became Germany's primary tank, the M48 needed one more chance to stay relevant or risk obsolescence. In the 1990s, the Krauss-Maffei Wegmann company started a private venture to modernize the M48A2 with a new engine, appliqué armour package, and updated fire control system as the "M48 Super". Although the venture aimed to export this upgrade services to other M48 users across the globe, this came right around the end of the Cold War as all European nations began downsizing their armies by selling their surplus tanks on the market, reducing the need to rely on the old M48 design and ending the venture.

Introduced in [[Update "Starfighters"]], the M48 Super enhances all aspect of the important M48 characteristics, firepower, armour, and mobility, for better gameplay. A new modern computers for better use of the gun, namely a laser rangefinder and a thermal vision that can enhance the gunner's ability to locate and hit their target with the more lethal APFSDS round available. A stronger engine provides better mobility compared to the earlier M48s. Finally, armour is enhanced by composite screens attached to the turret, which substantially improves the overall protection, but the hull  is left untouched aside from a few steel screens. So for many players that are familiar with the M48, the M48 Super represent the gameplay supercharged to 11, and can give enemies expecting an old, antiquated target a nasty surprise.
...
* Suspension wheel, tracks, and torsion bars are 20 mm thick.
