...
The targeting process is manual and in average twice slower than tanks with turrets at the same tier or battle rating. However, the recoilless nature of the guns eliminates the need for retargetting between shots as the recoil is minimal. The short delay between shots eliminates the need for repositioning as it does not leave the target any time to retaliate.
...
Like an SPAA belt, you have to fire all 6 rifles before being allowed to start the reloading process. Your ammo capacity of 18 shells total (or 3 belts of 6) is limited, which will impact your combat performance as you're very likely to have to disengage in order to restock during a battle.
...
==== Ammunition ====
{{:M40A1C (106 mm)/Ammunition|M344A1, M361A1}}
...
* Extremely hard to use for new players, not user friendly 
