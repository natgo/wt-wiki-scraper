...
The '''{{Specs|name}}''' (shortened as '''{{Specs|pseudonym}}''') is a rank {{Specs|rank}} Italian medium tank {{Battle-rating}}. It was introduced in [[Update 1.85 "Supersonic"]]. The OF-40 MK2 a further upgrade of the OF-40 which included things such as an LLTV and a stabilized gun. Many consider Italy's first attempt at making an main battle tank post WW2. The OF-40 was made after experienced gained from the OTO Melara Leone project, it being a modified Leopard 1. The playstyle of the OF-40 MK2 in game will be very similar to that of the OF-40, although now the player has access to a stabilized 105mm cannon, something which allows players to fire on the move with more accuracy. Like the OF-40, the MK2 does have slightly better armour when compared to the Leopard 1, but even in this upgrade it sadly has the exact same weakspots present on the OF-40. Mobility wise the tank does not disappoint, its still able to keep up with the majority of the tanks at your battle rating. The OF-40 MK2 is armed with an 105mm cannon which is able to fire APFDS, HEAT and HESH munitions. The laser rangefinder from the previous OF-40 is kept. It does get access to night vision devices but still does not get access to thermals. Overall this tank can be quite effective when a player can work around its weaknesses and make the most of its strengths.
...
* [https://live.warthunder.com/feed/camouflages/?vehicle=it_of_40_mk_2a Skins and camouflages for the {{PAGENAME}} from live.warthunder.com.]
