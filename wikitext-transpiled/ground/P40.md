...
At the beginning of 1940, the Italians began work on a project for a heavy infantry support tank, which was to fight alongside the Italian medium tanks, all this started from the fact that during the war in Africa the medium and light tanks had a lack of armour and insufficient firepower against the Allied tanks, initially designated as the P75 for its 75/32mm cannon later changed to the longer 75/34 cannon with more power, there were many types of prototypes and armament configurations, then the hull was changed to replace it with a 420 HP V-12 SPA 342 petrol engine that was more efficient than the 330 HP diesel engine, eventually the wagon that came out was the P26/40, a heavy wagon due to its weight of 26 Tons for the Italian army guidelines, and the number 40 for the year of design, the vehicle would only see the battlefield in 1943, of which only 5 would be produced before the armistice and in turn would be captured by the Germans, who would produce a few examples by changing the engine or using them as a fixed position for the cannon

In the game the P26/40 added with the Italian tech tree in the  [[Update 1.85 "Supersonic"|1.85 "Supersonic" update]], proves to be a balanced vehicle between piercing shots and the more penetrating HEAT that manages to penetrate almost every tank it manages to meet, the mobility is neither too good nor too bad, instead, they talk about survival the vehicle can take some damage without problems, but only if you don't find enemy vehicles with more powerful cannons that can destroy you in one shot
