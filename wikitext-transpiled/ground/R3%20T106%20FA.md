...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} Italian light tank {{Battle-rating}}. It was introduced in [[Update 1.85 "Supersonic"]]. The R3 Capraia was made in at least 7 prototypes, each with their own differences. This specific one represented in game is equipped with 2 American made recoiless rifles attached to a turret. You're able to fire both HESH and HEAT rounds, paired up with its great mobility makes this a very nimble tank destroyer which is able to inflict serious damage to the enemy team when used by someone with great situational awareness and map knowledge. It does not have access to smoke grenades and has very poor armour but is able to compromise with its good firepower, mobility and also the ability to scout enemy vehicles which can aid you team in picking out targets they may have not spotted. The R3 Capraia is also very good at BR's higher than its own so keep that in mind when playing the vehicle.
