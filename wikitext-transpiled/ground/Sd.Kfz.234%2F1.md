...
The '''{{Specs|name}}''' was the second production model of the [[Sd.Kfz.234 (Family)|Sd.Kfz.234]], following the [[Sd.Kfz.234/2]]. It was a heavily armoured reconnaissance vehicle with a simple open-top turret housing a 20 mm autocannon alongside an MG42 machine gun, designed to combat infantry and light combat vehicles. From mid-1944 to early 1945, about 230 vehicles of this modification were produced, which went into service with reconnaissance battalions.

Introduced during [[Update 1.97 "Viking Fury"]] as a reward for the [[wt:en/news/6669-special-space-race-en|"Space Race" event]], the Sd.Kfz.234/1 combines the familiar chassis of the [[Sd.Kfz.234/2]] with the turret of the [[Sd.Kfz. 140/1]]. While not as heavily armoured as the latter, the mobility offered by the former's chassis grants the Sd.Kfz.234/1 excellent map manoeuvrability, allowing it to utilise its 20 mm autocannon against unsuspecting opponents.
