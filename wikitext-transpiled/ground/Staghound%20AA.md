...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} British Self-Propelled Anti-Aircraft (SPAA) Gun {{Battle-rating}}. It was introduced in [[Update 1.55 "Royal Armour"]] along with the initial British ground tree. A very mobile SPAA with dual-mounted .50 cal machine guns, it also has armour rivalling some other Rank I vehicles and can thus withstand a majority of the smaller shells, warranting its high battle rating.
