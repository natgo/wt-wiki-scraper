...
The T-44 sports a 90 mm thick frontal plate sloped under at 62°. Compared to the 45 mm thick armour of the T-34, the T-44 offers twice as much effective frontal armour thickness. We also should not forget the low profile, which allows the tank to use the terrain to either provide hardcover or to conceal the T-44's movement. However, the lower profile of Soviet tanks came at a cost of poor gun depression, and the T-44 is no exception, limiting possible hull-down positions considerably.
...
The armament of the T-44 is identical to the [[T-34-85]]. The ZiS-S-53 85 mm tank gun offers up to 148 mm of penetration with the stock BR-365K APHE ammunition, while the top BR-367 APCBC post-war round offers up to 164 mm of penetration. While this is an improvement over the BR-365A APHEBC round (aka the top round of the T-34-85), it is still overshadowed by other medium tank guns at the given BR spread, such as the KwK 42 L/70 on the Panther, the 90mm M3 gun on the T25, or the British OQF 20-pounder gun on the Centurion Mk.3. Interestingly, the BR-365A shell actually sports significantly more HE filler and better-sloped performance, making it a better round in general. Penetration can be boosted up to 200 mm by using BR-367P APCR rounds, but against sloped armour, this round will struggle to penetrate like any APCR round in the game. That said, it is obvious the firepower is not exactly the strongest trait of the T-44. In fact, it was this very problem which in real life that led Soviet engineers to develop upgunned T-44-100 and T-44-122 prototypes, armed with 100 mm and 122 guns respectively.

==== Ammunition ====
{{:ZIS-S-53 (85 mm)/Ammunition|BR-365K, BR-365A, BR-365P, BR-367, BR-367P, O-365K}}
...
|-
|}
The coaxial MG is only usable against open top vehicles or to mark enemies for teammates.

== Usage in battles ==
<!-- ''Describe the tactics of playing in the vehicle, the features of using vehicles in the team and advice on tactics. Refrain from creating a "guide" - do not impose a single point of view but instead give the reader food for thought. Describe the most dangerous enemies and give recommendations on fighting them. If necessary, note the specifics of the game in different modes (AB, RB, SB).'' -->
The T-44 is a tank that has great mobility and agility, with a somewhat bouncy but not impenetrable armour. All of these traits produce a recipe for a good flanker. In tight city maps such as Cologne or Stalingrad, the T-44 is great at out-circling lumbering heavies and placing shots in their flanks, as well as in capping target zones in Domination and Break modes. On large open maps such as Mozdok or Kursk, the T-44 can be used to outflank the enemy and either cap the enemy's base (when playing Battle mode), or rush into the enemy rear and surprise any enemy tanks by shooting them from behind. Stay mobile as much as possible and engage only when penetration is assured - the T-44 is simply not sturdy enough to survive head-on shootouts with enemy heavy tanks and tank destroyers. The 85 mm cannon will struggle at its BR and you will need to rely on immobilising and shooting out the cannon of enemies. If used properly, the T-44 will serve well as a highly mobile effective medium tank. Experiences earned with this tank is also easily transferable, as the next few Soviet tanks, the [[T-44-100]] and [[T-54 (1947)]], are played nearly the same way, except with a much stronger gun on the former, and better armour on the latter.

Enemies worth noting:

* [[Tiger II (H)|Tiger II H]], [[Tiger II (10.5 cm Kw.K)|105]] and [[Tiger II (H) Sla.16|Sla.16]]: Load APCR with 200 mm of penetration and shoot at the right turret cheek to knock out the gunner, but flanking is advised.
...
* [[Jagdpanther]]: Lower front plate. It's best to immobilise and flank.
* [[Ferdinand]] and [[AMX-50 Foch]]: Head-on encounters should be avoided at all times. It's best to immobilise and flank.
...
* [[M48A1|M48]]: Cupola and some parts of the LFP might be penetrated.
* [[T32]]: LFP sometimes with upgraded APHE and machine gun port.
* [[T32E1]]: Head-on encounters should be avoided at all times. Immobilise and shoot out its gun, then shoot the sides of the hull.
* [[T34]]: Some parts of the LFP with APHE, flanking is highly advised.
* [[T26E1-1]]: Bounces a lot of shells. Aim for the machine gun port.
* [[T95]]: Hit the cupola.
* [[Tortoise]]: Cupola or the back can be penetrated.
* [[Caernarvon]]: Hit the lower front plate.
* [[Centurion (Family)|Centurions]]: Flanking is advised.
* [[AMX-50 Surblinde]]/[[AMX-50 (TOA100)|Surbaisse]] and [[Somua SM]]: It's best to flank and shoot the turret autoloaders, triggering a ammo detonation.
...
* 90 mm upper glacis is invulnerable to many enemy shells due to its ~60° slope
* Small profile
...
* APHE has a good amount of HE filler

'''Cons:'''

* HEAT and APDS rounds will penetrate your upper front glacis
* Gun may prove insufficient at dealing with many tanks
