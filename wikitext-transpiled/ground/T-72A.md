...
The T-72A has the powerful 2A46 125 mm smoothbore cannon. It has a powerful selection of rounds, each with different uses and similarities between same types.
...
* [[XM-1 (Chrysler)]]/[[XM-1 (GM)|(GM)]]: Avoid attempting combat with the 3BK18M HEATFS shells, despite them having thin composite armour
...
* Potent 125 mm cannon with high accuracy and muzzle velocity
* Low profile, especially when compared to NATO counterparts
* Access to a laser rangefinder
* Has both smoke grenade launchers and ESS
* Great turret armour and decent enough hull protection
* Has access to the powerful 3BM22 round
* Autoloader means the gun will continue reloading despite any fires or crew casualties

'''Cons:'''

* Terrible survivability thanks to the large autoloader in the hull and limited crew
* Abysmal reverse speed at -4 km/h
* Gun depression of -6 degrees leaves some to be desired
* Large weak spots which include the driver's port and LFP
* Mediocre optics with only one 8x zoom level
* Glacis armour is not reliable until the add-on armour plate is unlocked
