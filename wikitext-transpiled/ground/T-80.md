...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} Soviet light tank {{Battle-rating}}. It was introduced during the Closed Beta Test for Ground Forces before Update 1.41. An upgrade over the [[T-70]], the T-80 introduces a larger turret, allowing for an extra crew member to shorten the reload time and increase the tank's survivability in the battlefield.

Just like the previous [[T-70]], the T-80 boasts strong frontal armour and high mobility in a compact package. However, several notable upgrades are present. These upgrades include an increased crew count, rate of fire, and cannon elevation range.
...
{{:20-K (45 mm)/Ammunition|BR-240, BR-240SP, BR-240P, O-243}}
...
* To drastically reduce chances of ammunition explosion, pack 27 shells (racks 1 to 6 empty).
