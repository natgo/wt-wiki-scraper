...
* Great armor combined with CONTACT-5 ERA provides solid protection against both KE and Chemical munitions
* Various powerful ammunition types available, namely HE, APFSDS and ATGMs
* Accurate high muzzle velocity gun combined with a laser rangefinder provides great long range capability
* Autoloader provides a constant and decently quick reload
* Nimble tank for its size and weight; a fully upgraded T-80U is much more responsive than the T-80B
* Low silhouette, a hull-down T-80U is hard to spot and harder to hit
* -11 km/h reverse speed is much better than its brother, the T-72

'''Cons:'''

* Classical Soviet tank weakspots, namely the breach, lower front plate, and the drivers port
* Gaps between ERA plates can be weakspots
* The cramped interior and crew presents low survivability from a penetrating hit
* High risk of an ammo rack detonation due to the vertical ammunition carousel in the center of the hull
* Spare ammunition is distributed around the hull and turret, so it is advised to take no more than 29 shells
* Still a relatively low reverse speed and lack of neutral steering, making traversing the hull and retreating difficult
* Poor gun depression of -5° due to the low silhouette and turret height, makes it difficult to perform well on hilly terrain
