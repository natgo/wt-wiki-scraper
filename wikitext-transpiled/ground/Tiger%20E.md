...
* Decent cannon with adequate accuracy and a range of shells to choose. Stock shell has great penetration and damage, and can take out common opponents easily (e.g. T-34-85, M4, IS-1, M6A1). Has access to a piercing APCR with 200+mm penetration, which is effective against thick, flat armour found on the Churchill Mk.VII or [[Ho-Ri Production|Ho-Ri]] (mixed battle)
...
* Has access to a pintle-mounted MG which can fend off low-flying aircraft or knock out the exposed crew of some vehicles (e.g. GAZ trucks, [[M18 GMC|M18]]'s commander)
* Slight increase in lower front plate armour
