...
The '''{{Specs|name}}''' is among the earliest of the production variant of the [[Type 74 (Family)|Type 74]], it has some of the early ammunition set for the 105 mm L7A3 cannon. The most distinctive difference between the {{PAGENAME}} and the next [[Type 74 (E)]] is the C version lacks the thermal shroud around the 105 mm L7A3 cannon (this feature was introduced in the Type 74 (D) variant).

It was introduced in [[Update "Direct Hit"]]. As the earliest of the Type 74s, and has only APDS, HEAT and HESH ammunition. It does not have the APDSFS rounds that the later versions have. It has average mobility and a hydropneumatic suspension system that allows it to adjust its height and angle according to the terrain. It also has a laser rangefinder and a warning system that make it effective as a sniper.
