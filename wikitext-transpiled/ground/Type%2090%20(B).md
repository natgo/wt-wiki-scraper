...
The '''{{Specs|name}}''' ({{Annotation|90式戦車B型|Kyūmaru Shiki Sensha, 'B' Gata}}) is a small alteration on the [[Type 90]] equipping mounting plates on the hull to allow for the Type 92 mine roller. 
