...
The '''{{Specs|name}}''' is a prototype vehicle from the late 1950s based on the Unimog 404 truck chassis, developed by the Landsverk company in collaboration with Daimler-Benz. The prototype wsa equipped with two 81 mm Oerlikon rocket launchers. Only one prototype was built and tested, but it never got any orders and was abandoned.
