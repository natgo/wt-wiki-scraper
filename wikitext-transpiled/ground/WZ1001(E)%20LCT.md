...
The '''{{Specs|name}}''' (Long Cannon Testbed) (Chinese: WZ1001(E) 125毫米多功能火炮试验车; lit. 125 mm Multipurpose Gun Test Vehicle) was one of the prototypes of what would later become the ZTZ99A. Even before the ZTZ99 had been introduced to the PLAGF, there were already plans for a new "3rd generation tank", with the ZTZ99 (industrial code WZ123) acting as a stop-gap before the new tanks could be introduced. As soon as the ZTZ99 was certified in the early 2000s, Institute 70 began the WZ1001 program with various designs led by the new chief designer Mao Ming (毛明). The WZ1001(E) LCT represents the 2nd prototype of the WZ1001 program, featuring a longer L/54 125 mm smoothbore cannon and a hull based on the [[ZTZ99-III]]. Due to economics and better reliability for the gun system, the LCT was ditched, and the other prototype with an L/48 cannon was then certified as what is known as the [[ZTZ99A]].

Introduced in [[Update "Apex Predators"]], the WZ1001(E) LCT has mostly identical performance to its (technological) successor, the ZTZ99A, though with better gun handling thanks to its experimental gun layer and high muzzle velocity. However, do remember that the hybrid of a ZTZ99 hull with a ZTZ99A-like turret means their flaws are inherited by the WZ1001, and players should be cautious about when to utilise its great mobility to assault enemies - planning ahead is essential for the tank's survivability.
