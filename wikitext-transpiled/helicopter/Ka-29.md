...
The Kamov Ka-29 (NATO reporting name "Helix") has an odd appearance, even by the standards of Soviet helicopters. It has the signature Kamov coaxial rotor arrangement that eliminates the need for a tail rotor. The boxy fuselage and wide cabin are evidence of its roots in the standard Ka-27 anti-submarine/search-and-rescue model, of which the Ka-29 is a gunship variant. While it won't win any beauty contests and does not look nearly as threatening as the contemporary [[Mi-24V]]/[[Mi-24P|P]] attack helicopters, the Helix has a surprising amount of firepower and should not be underestimated. It has 9M114 Shturm ATGMs, flares, HIRSS, and a ballistic computer just like the Hinds. For close-in work, it has access to the same 30 mm 2A42 autocannon used by the [[BMP-2]]. Pilots who enjoy the agility of this Kamov can look forward to the succeeding [[Ka-52]] Allligator, a thoroughbred attack helicopter design that is one of the most capable in War Thunder.
...
The Ka-29 can optionally mount a much more threatening 30 mm 2A42 autocannon on the left side of the fuselage. It only has 200 rounds, but that is enough to do some serious damage to light vehicles. It even has access to APDS rounds, which can penetrate the roof and side armour of MBTs without too much trouble.
