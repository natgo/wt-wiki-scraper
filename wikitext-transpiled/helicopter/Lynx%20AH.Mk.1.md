...
The 71C is the first-unlocked guided munition of the Lynx. It boasts a maximum of 630 mm of armour penetration with an effective guidance range of 3.75 km which it travels at 296 m/s. The missile is SACLOS (Semi-Automatic Command to Line of Sight) meaning that it must be guided for the entire duration of the flight, breaking the designation will cause the missile to lose course most of the time. This style of missile can be defeated by soft-kill APS systems like those found on the PUMA which will be a commonly encountered opponent. Each missile contains the equivalent of 2.88 kg of TNT. The warhead is HEAT and can be defeated by ERA armour. This missile will still reliably kill nearly anything encountered at the battle rating.

{{Notice|The regular ATGM control corridor for TOW is extremely small, unlike with the previous SS.11, so it requires the helicopter to face the target for the entirety of the flight time. But, if the pilot turns on laser guidance (generally done automatically with "lock onto target" button) before launch, the TOW will remain controllable well outside its regular operational area and allow the Lynx to fire AAMs at unwanted visitors or dodge while attacking just like the Scout or the Wasp. Whether this is a bug or a feature is unknown. The same behaviour persists with later missiles as well.}}

'''BGM-71D TOW-2 missile:'''

The 71D is an upgrade to the above 71C, however it does not offer any improvement on range, maintaining the 3.75 km maximum but with an increased travel speed of 329 m/s. The missile is still SACLOS. Each missile contains 4.41 kg of TNT equivalent. The warhead is HEAT and can be defeated by ERA armour, but the missile will reliably kill almost anything encountered at the battle rating and has enough explosive filler to overpressure some lighter vehicles if a direct hit is not achieved.

'''AGM-114B Hellfire missile.'''

The Hellfire missile is the ultimate upgrade for the Lynx, the missile more than doubles the range of the older TOW missiles with a maximum range of 8 km which it can travel at 475 m/s. The missile is Laser + IOG (In-Ordnance Guidance) meaning that it relies on laser designation unlike the older missiles and can continue to direct itself to the last known position of the laser if the designation is lost, meaning the missile can deliver itself to static targets independent of guidance by the launching aircraft and will not fly off course.

The missile cannot be defeated by soft-kill APS systems like the TOW, however it can still run afoul of some stronger ERA armours. However, with an incredible 1,100 mm of armour penetration this is very unlikely. This excellent penetration comes with explosives equivalent to 9.02 kg of TNT which again is double that of its preceding TOW. Anything at the receiving end of a Hellfire will certainly know about it, ending up crippled even if not outright destroyed.
