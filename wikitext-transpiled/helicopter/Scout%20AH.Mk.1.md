...
The '''{{Specs|name}}''' is a rank {{Specs|rank}} British utility helicopter {{Battle-rating}}. It was introduced in [[Update 1.91 "Night Vision"]]. It serves as an opening helicopter for British pilots that will familiarise them with the game's helicopter mechanics.
