...
The '''Harbin Z-19E''' is the export version of the [[Z-19]]. A mock-up of the helicopter was shown at the Zhuhai Airshow in 2016, and the first prototype took to the air in 2017. Production of this version uses a wider range of composite materials, which increases its quietness and flight safety, as well as reducing the aircraft's weight. In addition, the helicopter received new engines. It was expected that Pakistan would be one of the customers; however, at present, there is no information about the further development of the project.
